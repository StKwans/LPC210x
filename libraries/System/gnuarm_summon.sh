...
if [ ! -e ${STAMPS}/${BINUTILS}.build ]; then
    ...
    ${SUDO} rm -rfv ${PREFIX}/${TARGET} ${PREFIX}/bin/${TARGET}-* ${PREFIX}/lib/gcc/${TARGET}
    ${SUDO} rm -rfv ${PREFIX}/libexec/gcc/${TARGET} /usr/bin/${TARGET}-*
    ${SUDO} rm -rfv ${PREFIX}/share/man/man?/${TARGET}-* /usr/bin/${TARGET}-*
    pwd
